    ...
    <footer className="bg-[#121212] pt-16 pb-8 border-t-[4px] border-[#004b93] font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div className="flex gap-4 mb-12">
          {/* Facebook */}
          <a href="https://www.facebook.com/ICBOYS" className="w-10 h-10 rounded-full border border-gray-600 bg-transparent flex items-center justify-center text-white hover:bg-[#004b93] hover:border-[#004b93] hover:scale-110 transition-all duration-300 group">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/iceboys.icb?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="w-10 h-10 rounded-full border border-gray-600 bg-transparent flex items-center justify-center text-white hover:bg-[#004b93] hover:border-[#004b93] hover:scale-110 transition-all duration-300 group">
